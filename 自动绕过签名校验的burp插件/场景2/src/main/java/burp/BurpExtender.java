...
public class BurpExtender implements IBurpExtender,IHttpListener {
    ...
    public void processHttpMessage(int toolFlag, boolean messageIsRequest, IHttpRequestResponse messageInfo){
        ...
        if(toolFlag == IBurpExtenderCallbacks.TOOL_REPEATER && messageIsRequest){
            ...
            for(IParameter parameter : parameters){
                if(parameter.getType() == IParameter.PARAM_BODY){
                    ...
                    if("sig".equals(parameter.getName())){
                        ...
                        data += parameter.getName()+"="+timestamp+"&";
                        req = helpers.updateParameter(req, helpers.buildParameter("timestamp",timestamp,IParameter.PARAM_BODY));
                    }
            ...
            sig = MD5Util.getMD5Str(finalStr);
            stdout.println("sig: "+sig);
            messageInfo.setRequest(helpers.addParameter(req,helpers.buildParameter("sig",sig, IParameter.PARAM_BODY)));
        }
